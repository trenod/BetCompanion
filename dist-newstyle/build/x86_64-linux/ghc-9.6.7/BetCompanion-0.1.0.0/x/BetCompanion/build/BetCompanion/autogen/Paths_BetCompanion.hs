...
-- at runtime using the environment variable BetCompanion_bindir.
...
-- environment variable BetCompanion_libdir.
...
-- using the environment variable BetCompanion_dynlibdir.
...
-- runtime using the environment variable BetCompanion_datadir.
...
-- variable BetCompanion_libexedir.
...
-- using the environment variable BetCompanion_sysconfdir.
...
bindir     = "/home/twb/.cabal/bin"
libdir     = "/home/twb/.cabal/lib/x86_64-linux-ghc-9.6.7/BetCompanion-0.1.0.0-inplace-BetCompanion"
dynlibdir  = "/home/twb/.cabal/lib/x86_64-linux-ghc-9.6.7"
datadir    = "/home/twb/.cabal/share/x86_64-linux-ghc-9.6.7/BetCompanion-0.1.0.0"
libexecdir = "/home/twb/.cabal/libexec/x86_64-linux-ghc-9.6.7/BetCompanion-0.1.0.0"
sysconfdir = "/home/twb/.cabal/etc"

getBinDir     = catchIO (getEnv "BetCompanion_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "BetCompanion_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "BetCompanion_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "BetCompanion_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "BetCompanion_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "BetCompanion_sysconfdir") (\_ -> return sysconfdir)
